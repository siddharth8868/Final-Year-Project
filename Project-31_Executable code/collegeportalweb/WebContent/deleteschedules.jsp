...
<div align="center"><h2>Delete Schedules</h2><br>

  	  <form action="deleteschedules.jsp">
...
<div style="margin-left: 15px; margin-right: 15px;" align="center" >
	...
	<table>
		  ...
		  <col width="10%">
		  <col width="5%">
 <tr><td>Sl.No</td><td>SUBJECT</td><td>POSTED</td><td>VALID</td><td>LINK</td><td>UPLOADER</td><td>DEL</td></tr>
  ...
  catch(Exception e)
  {
	...
	<div align="center"><h4></h4>
		<form id="sending" action="DeleteSchedulesServlet" method="post">
