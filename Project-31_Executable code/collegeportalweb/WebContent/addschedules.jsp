...
<script type="text/javascript" src="js/addschedules.js"></script>
...
<div align="center"><h2>Add Schedule</h2></div>

<div style="margin-left:20px;">

<form action="AddScheduleServlet" method="post" enctype="multipart/form-data">	
<table cellspacing="6">
	...
	<tbody>
      ...
      <tr>
      	<td>Validity:</td>
      	<td><input type="text" name="validity" id="validity" style="width:200px;"/></td>
      </tr>
      <tr>
    			<td>Branch:</td>
